 ...
 */
	...
	function collapse( vertices, faces, u, v ) {
		...
		if ( ! v ) {
			...
			// console.log('removing vertex and returning')
		...
		// console.log('finished for loop 1')
		...
		for ( let i = u.faces.length - 1; i >= 0; i -- ) {
			...
			// console.log(u)
			// console.log(u.faces)
			// console.log(u.faces[i])
			// console.log(i)
			// console.log('did for loop 2 part 1 now doing while loop, i = '+i)
			while(i > 0 && u.faces[i-1] == undefined){
				i--
				if(i == 0) break
			}
			// console.log('now i = '+i)
		...
		// console.log('finished for loop 2')
		for ( let i = u.faces.length - 1; i >= 0; i -- ) {
			u.faces[ i ].replaceVertex( u, v );

		}
		// console.log('finished for loop 3')
		...
		// console.log('finished for loop 4')
	}
